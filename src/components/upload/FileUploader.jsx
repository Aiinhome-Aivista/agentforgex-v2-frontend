...
export default function FileUploader({ onAnalyze, loading, disabled, loader }) {
  ...
  return (
    <div className={clsx(
      ...
      <div className="flex justify-center">
        <button
          ...
          className={clsx(
            ...
            disabled
              ? 'opacity-50 cursor-not-allowed bg-brand-500/50 text-black/50'
      ...
      >
        {tab === null ? (
          <div
            ...
            className={clsx(
              "w-full p-16 text-center flex flex-col items-center gap-4 group",
          ...
          <>
            ...
            <UploadSidebar tab={tab} setTab={setTab} setFiles={setFiles} setUserInput={setUserInput} disabled={disabled} />
      ...
      <FileList files={files} removeFile={removeFile} tab={tab} userInput={userInput} removeText={() => { if (!disabled) setUserInput(''); }} disabled={disabled} />
      ...
      {loading && loader ? (
        ...
        >
          ...
          <div className="relative flex items-center justify-center gap-3">
            {loading ? (
              <><Loader2 size={18} className="animate-spin text-brand-500/60" /><span className="text-brand-500/60 font-bold">Thinking Process...</span></>
            ) : (
              <>
