...
import { AuroraBackdrop, ParticleField, OrbitSparks } from "./LoaderFX";
        ...
        {!isCompleted ? (
          isWaitingForApi ? (
            ...
            <motion.div
              ...
              exit={{ opacity: 0, scale: 0.95 }}
              transition={{ duration: 0.4, ease: "easeOut" }}
              className="fx-sheen w-full max-w-4xl bg-brand-surface/40 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden flex flex-col md:flex-row gap-8 items-center"
            >
              {/* Ambient background */}
              <AuroraBackdrop />
              ...
              {/* ══════════════════════════════════════════════════════════════
                 ...
                 ══════════════════════════════════════════════════════════════ */}
              <div className="relative z-10 w-full md:w-1/2 flex flex-col items-center justify-center space-y-6">
                ...
                <div className="relative w-[260px] h-[280px] flex items-center justify-center">
                  ...
                  <div className="absolute w-[180px] h-[180px] rounded-full bg-brand-500/5 blur-xl fx-glow-pulse" />

                  {/* Orbiting sparks around the arena */}
                  <OrbitSparks size={250} dots={6} />

                  {/* Stage environment scene */}
                  <StageEnvironment stageIndex={isWaitingForApi ? 7 : activeStep} />

                  {/* Doodle Robot — positioned centrally, gently floating */}
                  <div className="relative z-10 fx-floatY">
                ...
                <div className="w-full text-center space-y-2 px-4">
                  ...
                  <div className="space-y-2 mt-4 max-w-xs mx-auto">
                    <div className="w-full h-1.5 rounded-full bg-white/5 border border-white/10 overflow-hidden relative">
                      <motion.div
                        className="h-full bg-gradient-to-r from-emerald-500 to-cyan-400 rounded-full relative overflow-hidden"
                        animate={
                          isWaitingForApi
                            ? { width: ["95%", "99%", "95%"] }
                      ...
                      >
                        {/* moving stripes */}
                        <div className="absolute inset-0 fx-bar-stripes opacity-60" />
                        {/* glowing leading edge */}
                        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-white shadow-[0_0_10px_3px_rgba(255,255,255,0.7)]" />
                      </motion.div>
                    </div>
              ...
              {/* ══════════════════════════════════════════════════════════════
                 ...
                 ══════════════════════════════════════════════════════════════ */}
              <div className="relative z-10 w-full md:w-1/2 flex flex-col justify-center pl-0 md:pl-8 border-t md:border-t-0 md:border-l border-white/5 pt-8 md:pt-0">
          ...
          <motion.div
            ...
            className="fx-sheen w-full max-w-md bg-brand-surface/40 backdrop-blur-2xl border border-white/10 rounded-3xl p-10 shadow-2xl relative overflow-hidden flex flex-col items-center justify-center text-center space-y-6"
          >
            {/* Soft background glow + celebratory particles */}
            <AuroraBackdrop />
            ...
            <div className="relative z-10 w-20 h-20 flex items-center justify-center">
              ...
              <div className="absolute w-16 h-16 rounded-full border-2 border-brand-500/40 fx-ring-ping" />
              <div className="absolute w-16 h-16 rounded-full border-2 border-cyan-400/30 fx-ring-ping" style={{ animationDelay: "0.6s" }} />
              {/* Outer pulsing ring */}
              <motion.div
            ...
            <div className="relative z-10 space-y-2">
              <h2 className="text-2xl font-black gradient-text-animated">
                Analysis Complete
              </h2>
